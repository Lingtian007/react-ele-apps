...
class Shop extends Component {
  ...
  order = (money) => {
    console.log("1111", this.state.totalPrice);
    console.log("this.props", this.props);
    console.log("this.state.miniMoney", this.state.miniMoney);
    
    this.props.history.push({
      pathname: "/order",
      query: {
        shopid: this.state.shopId,
        geohash: this.state.geo
      }
    });
  ...
  initData = async id => {
    ...
    this.setState({
      geo: this.props.geohash[0] + "," + this.props.geohash[1]
    });
    // console.log(obj);
  ...
  render() {
    console.log("this.state.displayList", this.state.displayList);
    return (
          ...
          {this.state.show && (
            <div className="food-container">
              ...
              <div className="buy-cart-container">
                ...
                <div
                  onClick={this.order.bind(this, this.state.miniMoney)}
                  className={
